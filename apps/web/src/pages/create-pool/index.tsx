        ...
        <Box as="form" onSubmit={handleSubmit} w="full">
          <VStack spacing={4}>
            <FormControl id="pool-name">
              ...
              <Input type="text" placeholder="Which is your organization?" />
            </FormControl>
            ...
            <FormControl id="pool-description">
              ...
              <Textarea placeholder="What projects are you targeting? Why should they receive money from this pool?" />
            </FormControl>
            ...
            <FormControl id="max-streaming-per-month">
              ...
              <Input type="text" placeholder="Examples: 20000 or 4%" />
            </FormControl>
