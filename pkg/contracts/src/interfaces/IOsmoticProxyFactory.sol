...
interface IOsmoticProxyFactory is IDefaultImplementationBeacon {
    /**
     *
     */
    /**
    ...
    event ImplementationRegistered(
        uint256 indexed version_, address indexed implementationAddress_, address indexed initializer_
    );
    ...
    /**
     *  @dev   The OsmoticController was set.
     *  @param controller_ The address of a Osmotic Controller contract.
     */
    event OsmoticControllerSet(address indexed controller_);
    ...
    /**
     *  @dev The address of the OsmoticController contract.
     */
    ...
    /**
     *  @dev   Sets the Osmotic Controller contract.
     *         Only the Governor can call this function.
     *  @param controller_ The address of a Osmotic Controller contract.
     */
